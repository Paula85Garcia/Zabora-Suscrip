...
public class RespuestaPagoDTO {
    ...
    @Schema(description = "Mensaje descriptivo del resultado", example = "Pago aprobado correctamente")
    private String mensaje;

    @Schema(description = "ID del pago en Mercado Pago", example = "12345678901")
    private String idPago;

    @Schema(description = "Estado del pago segun Mercado Pago", example = "approved")
    ...
    @Schema(description = "Fecha de creacion del pago")
    ...
    @Schema(description = "Indica si el pago esta pendiente y requiere accion adicional (PSE, efectivo, etc.)",
            example = "false")
    ...
    @Schema(description = "Indica si el usuario solicito recibir factura por email", example = "true")
